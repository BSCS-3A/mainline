...
--
-- Host: localhost:3306
-- Generation Time: Mar 03, 2021 at 07:32 AM
...
INSERT INTO `student` (`student_id`, `fname`, `Mname`, `lname`, `gender`, `bumail`, `otp`, `voting_status`, `photo`) VALUES
(123456126, 'boboy', 'm', 'pink', 'nogender', 'boboymamamo.pink@bicol-u.edu.ph', 'asdfdf', 0, ''),
(123456127, 'paul', 'j', 'sta. ana', 'nogender', 'pauljay.sta.ana@bicol-u.edu.ph', 'sdffgd', 0, '');
