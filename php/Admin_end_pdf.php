		...
		if($data['candidate_id']==$lastCandidate['last']){ 
			...
			if ($data['vote_allow']==1){
				...
				if(in_array("7", $keyword)){
					...
					$abstainedGrade7=$enrolled[1]-$sumGrade8;
					$abstainedGrade8=0;
					$abstainedGrade9=0;
					$abstainedGrade10=0;
					$abstainedGrade11=0;
					...
					$abstainedGrade7=0;
					$abstainedGrade8=$enrolled[2]-$sumGrade9;
					$abstainedGrade9=0;
					$abstainedGrade10=0;
					$abstainedGrade11=0;
					$abstainedGrade12=0;
					...
					$abstainedGrade7=0;
					$abstainedGrade8=0;
					$abstainedGrade9=$enrolled[3]-$sumGrade10;
					$abstainedGrade10=0;
					$abstainedGrade11=0;
					$abstainedGrade12=0;
					...
					$abstainedGrade8=0;
					$abstainedGrade9=0;
					$abstainedGrade10=$enrolled[4]-$sumGrade11;
					$abstainedGrade11=0;
					$abstainedGrade12=0;
					...
					$abstainedGrade9=0;
					$abstainedGrade10=0;
					$abstainedGrade11=$enrolled[5]-$sumGrade12;
					$abstainedGrade12=0;
				}
			}
